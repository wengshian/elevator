...
test_case_3 = [(2,10, i, 5) for i in range(1,100)] #Test case where there are exactly 3 different elevator requests that are the same
...
test_case_9 = [(2,10, 1, 5) for i in range(12)] +  [(8,11, 3, 5) for i in range(12)]+  [(9,12, 5, 5) for i in range(3)] 
test_case_10 = [(2,10, 1, 5) for i in range(12)] +  [(8,11, 3, 5) for i in range(6)]+  [(12,9, 7, 5) for i in range(3)] 
...
if __name__ == "__main__":
    ...
    if args.sim in ["1", "true", "True"]:
        sim = True
    else:
        sim = False

    if args.verbose in ["1" , "true", "True"]:
        verbose = True
    else:
        verbose = False
